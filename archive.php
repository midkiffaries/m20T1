...
<main class="page-main page-archive width-side" id="main-content" itemscope itemtype="https://schema.org/Article" itemprop="mainEntity">
    ...
    <section class="archive-header" id="archive-page">
        <div class="archive-header-container">
            ...
            <p class="is-style-text-subtitle has-permanent-marker-font-family is-style-text-subtitle--1 wp-block-paragraph" itemprop="about">
        ...
        <div class="author-container">
            ...
            <div class="author-content">
                ...
                <p class="author-bio-contact">
                    ...
                    <?php if ($curauth->youtube) : ?><a href="<?=esc_url($curauth->youtube);?>" rel="author" itemprop="sameAs">YouTube</a> | <?php endif; ?>
