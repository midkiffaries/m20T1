...
add_filter( 'register_block_type_args', function( $args, $block_type ) {
    if ( in_array( $block_type, ['core/group', 'core/list-item', 'core/buttons', 'core/text', 'core/media-text', 'core/details', 'core/column', 'core/legacy-widget', 'core/cover', 'core/table', 'core/pullquote', 'core/code', 'core/embed', 'core/video', 'core/latest-posts', 'core/social-links', 'core/legacy-widget', 'core/verse', 'core/calendar', 'core/search'], true ) ) {
...
function attachment_page_image( $id ) {
    ...
    if ($fileExt == 'svg' || $fileExt == 'svgz') { // SVG Images
        ...
        return '<script defer type="module" src="https://ajax.googleapis.com/ajax/libs/model-viewer/4.0.0/model-viewer.min.js"></script><model-viewer id="Model3D" class="aligncenter" itemprop="image" style="height:380px;min-width:400px" src="' . wp_get_attachment_url($id) . '" alt="' . wp_get_attachment_caption($id) . '" ar poster="" shadow-intensity="0" exposure="1.1" shadow-softness="0" tone-mapping="commerce" camera-controls touch-action="pan-y"></model-viewer>';
...
add_action('wp_dashboard_setup', function(){
    ...
    function custom_dashboard_text() {
        ...
        <p>Underline Text: <kbd>CTRL+U</kbd> / <kbd>CMD+U</kbd></p>
