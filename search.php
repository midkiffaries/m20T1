...
<main class="page-main page-search width-side" id="main-content" itemscope itemtype="https://schema.org/SearchResultsPage" itemprop="mainEntity">
    ...
    <section class="search-page-form" id="search-page">
        <div>
            ...
            <?php get_search_form(['search-page']); // Search form ?>
    ...
    <article class="search-results" itemscope itemtype="https://schema.org/SearchResultsPage">
        <div class="the-content aligncenter" itemprop="text">
            ...
            <div class="page-search-image">
                <?=get_option('search_image') ? '<img src="'.esc_url(get_option('search_image')).'" loading="lazy" decoding="async" itemprop="image" alt="" fetchpriority="auto" style="max-width:500px">' : '<svg role="img" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 136 136"><path d="M131.3 115.3 99.2 88c-3.3-3-6-5.8-8.8-5.6a50.8 50.8 0 1 0-39.6 19.2c12.6 0 23.3-3.7 32.1-11.3-.1 2.9 2.1 5.6 5 8.9l27.4 32c4.7 5.3 12.3 5.7 17 1s4.2-12.2-1-17zM50.8 84.7a33.9 33.9 0 1 1 0-67.8 33.9 33.9 0 0 1 0 67.8z"/><path d="m47 69.8-6.7-6.2L39 77.2l-3-15.7-10.4 8.1 10-10-12.8-7.2L37 54.6l1-21.7 3.5 22L52 49.6l-8 8.1L61 56.5l-18.5 4.8z"/></svg>';?>
