...
add_action( 'init', function(){
    ...
    register_block_style( 'core/gallery', [
        ...
        .is-style-gallery-2 .wp-block-image::before {
            height:0 !important;
        }
...
// Remove jQuery Migrate and load jQuery from WordPress core without the migrate script for better performance
...
add_action('init', function(): void {
    ...
    // Bear Logo 2
	wp_register_icon('m20t1/bearlogo2', [ 
		'label'   => __('Bear Logo 2', 'm20t1-icons'),
		'content' => '<svg xmlns="http://www.w3.org/2000/svg" width="175" height="175" viewBox="0 0 175 175"><g><path d="M128.2 143.8A80 80 0 0 1 89 154c-13.5-.2-27.5-3-39.1-10.2zm21.5-18.5c-2.8 4.1-6.6 7.4-10.2 10.7h-101a64 64 0 0 1-10.1-10.7zm9.5-16.7c-1 3.7-3.1 7-5 10.2H23.9q-3.1-4.8-5-10.2zm3.6-14.1q-.3 4.5-1.8 9H99.2c3.6-1.4 6.6-4.3 7-8.3v-.7zm-90.6 0v.7c.2 4.1 3.6 6.8 7.1 8.2H17.1q-1.5-4.3-1.9-9zm91-12.7.3 4.2c-.1 3.8 0 2.3-.2 4.5h-59.1c-3.5-4.2-9.9-5.3-15-5.4-4.4 0-12.4 1.5-15 5.4H14.7c-.3-2.2-.1-.7-.2-4.5.2-3.2 0-1.9.3-4.2zm-73.6-64c9 0 18 1.6 25.8 4.6 24.1 9.7 44.1 30.2 47.4 56.8H15.2c3.5-26 24.3-46.7 47.4-56.8q13.1-4.6 27-4.6m-21 41a8.7 8.7 0 1 0 0 17.4 8.7 8.7 0 0 0 0-17.4m41.5 0a8.7 8.7 0 1 0 0 17.4 8.7 8.7 0 0 0 0-17.4"/><path d="M42.8 11c7 .3 12.6 4.2 17.4 8.7A75 75 0 0 0 19.4 55c-4-4-4.2-10.5-4.8-15.6 0-15.8 12-28.3 26.8-28.3zm92.5 0h1.4c15 0 26.8 12.6 26.8 28.4-.6 5.1-.9 11.7-4.7 15.6-9-16.2-23-29-41-35.3a27 27 0 0 1 17.5-8.6"/></g></svg>'
	]);
    // Mail Envelope
    ...
    // Floppy Disk
	wp_register_icon('m20t1/floppydisk', [ 
		'label'   => __('Floppy Disk', 'm20t1-icons'),
		'content' => '<svg xmlns="http://www.w3.org/2000/svg" width="446" height="440" viewBox="0 0 118 117"><path d="M4.2 3.8h109.6v33.1H4.2z" fill="white"/><path d="M.7.1Q.2.1.2.7v114.9q0 .4.5.4h46.7a1.7 1.7 0 0 1 3.4 0H72a1.7 1.7 0 0 1 3.4 0h42q.3 0 .4-.4V32.2h-3v-5.5h3V.7q0-.5-.5-.6zm4.7 3.7h107.2q1.1 0 1.2 1.2v30.7q0 1.1-1.2 1.2H5.4q-1.1 0-1.2-1.2V5q0-1.1 1.2-1.2m55.7 37.6a17.4 17.4 0 0 1 0 34.8 17.4 17.4 0 0 1 0-34.8m21.4 20a2.7 2.7 0 0 1 0 5.5 2.7 2.7 0 0 1 0-5.3zM62 83.4c3 0 5.4 2.4 5.4 5.4v19.4a5.4 5.4 0 1 1-10.8 0V88.8c0-3 2.4-5.3 5.4-5.3"/></svg>'
	]);
    // Heart
	wp_register_icon('m20t1/heart', [ 
		'label'   => __('Heart', 'm20t1-icons'),
		'content' => '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><path d="M378 32c-54 0-101 44-122 90-21-46-68-90-122-90C60 32 0 92 0 166c0 151 152 191 256 340 98-148 256-193 256-340 0-74-60-134-134-134"/></svg>'
	]);
    // Book
	...
	wp_register_icon('m20t1/redbubble', [ 
		'label'   => __('RedBubble', 'm20t1-icons'),
		'content' => '<svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024"><path d="M710 696H573q-12-1-13-13V340q1-12 13-13h127c95 0 115 55 115 102q-1 41-22 65 53 23 54 93c0 69-52 109-137 109m-198 0H228q-12-1-14-13V340q2-12 14-13h132c83 0 133 44 133 119 0 49-25 88-66 104l95 124q3 3 3 9-1 12-14 13m0-696a512 512 0 1 0 0 1024A512 512 0 0 0 512 0"/></svg>'
	]);
    // Spring Logo
	wp_register_icon('m20t1/spring', [ 
		'label'   => __('Spring', 'm20t1-icons'),
		'content' => '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="37" viewBox="0 0 32 37"><path d="M10.7 36.7C8 36.7 4 35.9 0 32.3l3.1-3.5c5.6 5 11.4 3 13.2 1.4l.3-.3a19 19 0 0 1-10.4-5C1.7 20.3.7 14.3 3.9 11.1 7 8 13 8.9 17.6 13.2c.3.4 4.7 4.7 5.6 10.2a10 10 0 0 0 4.1-8.3 10 10 0 0 0-3-7.3c-2-2-5-3.1-8.1-3.1V0q6.8.1 11.3 4.4A15 15 0 0 1 32 15.1 15 15 0 0 1 22.7 29a12 12 0 0 1-3.3 4.6 13 13 0 0 1-8 3zm-2-22.8a2 2 0 0 0-1.5.6c-1.2 1.1-.4 4.4 2.3 7 0 0 4.2 4.1 9.2 3.7 0-4.4-4.3-8.5-4.4-8.6a9 9 0 0 0-5.5-2.7z"/></svg>'
	]);
});
...
class Menu_With_Description extends Walker_Nav_Menu {
    function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
        ...
        $item_output .= ! empty( $item->menu_thumbnail ) ? ' <img src="' . (($item->menu_img_url) ? esc_url($item->menu_img_url) : esc_url(get_the_post_thumbnail_url(url_to_postid($item->url), 'thumbnail'))) . '" class="menu-item-image" alt="" loading="lazy" decoding="async" fetchpriority="auto">' : '';
...
add_action( 'wp_nav_menu_item_custom_fields', function( $item_id, $item ) {
	...
	<p class="description" style="margin-bottom:10px">
        ...
        <input type="radio" id="menu_img_no-<?=$item_id;?>" name="menu_thumbnail[<?=$item_id;?>]" value="0"><label for="menu_img_no-<?=$item_id;?>">No</label> &nbsp;
        <input type="radio" id="menu_img_yes-<?=$item_id;?>" name="menu_thumbnail[<?=$item_id;?>]" value="1"><label for="menu_img_yes-<?=$item_id;?>">Yes</label>
    </p>
...
add_action( 'wp_update_nav_menu_item', function( $menu_id, $menu_item_db_id ) {
	if ( isset( $_POST['menu_thumbnail'][$menu_item_db_id] ) ) {
		$sanitized_data1 = sanitize_text_field( $_POST['menu_thumbnail'][$menu_item_db_id] );
		update_post_meta( $menu_item_db_id, 'menu_thumbnail', $sanitized_data1 );
	} else {
		delete_post_meta( $menu_item_db_id, 'menu_thumbnail' );
	}
    if ( isset( $_POST['menu_img_url'][$menu_item_db_id] ) ) {
		$sanitized_data2 = sanitize_text_field( $_POST['menu_img_url'][$menu_item_db_id] );
		update_post_meta( $menu_item_db_id, 'menu_img_url', $sanitized_data2 );
	} else {
...
function attachment_page_image( $id ) {
    ...
    if ($fileExt == 'svg' || $fileExt == 'svgz') { // SVG Images
        ...
        return '<script defer type="module" src="' . $model_url . '"></script><model-viewer id="Model3D" class="aligncenter" itemprop="image" style="height:380px;min-width:400px;border-radius:10px;border:3px solid #888;background-color:#0002;" src="' . wp_get_attachment_url($id) . '" alt="' . wp_get_attachment_caption($id) . '" ar poster="" shadow-intensity="0" exposure="1.1" shadow-softness="0" tone-mapping="commerce" camera-controls touch-action="pan-y"></model-viewer>';
...
// Pagination page numbers on the blog index pages
    ...
    <?php if ($post_pages > 1) : ?>
        <select id="pagination-select" class="pagination-select" aria-label="Jump to page" onchange="if(this.value)window.location.href=this.value">
            ...
            <?php foreach (range(1, $post_pages) as $page) : ?>
                ...
                <option value="<?=get_pagenum_link($page);?>" <?=$current_page;?>>Page <?=$page;?></option>
            <?php endforeach; ?>
        </select>
    <?php endif; ?>
    <?php
...
#wp-admin-bar-site-name .site-icon {background:none !important}
</style>
<?php
});
