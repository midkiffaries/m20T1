...
.wp-admin .type-model img, .wp-admin .thumbnail-model img, .wp-admin .attachment-compat .required-field-message, .wp-admin #alt-text-description {display:none !important}
