...
<footer class="page-footer" role="contentinfo">
    ...
    <div class="footer-notice">
        ...
        <div class="footer-footnote"><a href="https://github.com/midkiffaries/m20T1" class="wp-theme-title"><?php echo wp_get_theme()->get('Name'); ?> Theme</a> | <a href="<?php echo home_url(); ?>/privacy-policy/" rel="license">Privacy Policy</a></div>
    </div>
</footer>
