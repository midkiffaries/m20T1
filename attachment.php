    ...
    <?php while ( have_posts() ) : the_post(); // Display selected media ?>
        ...
        <article <?php post_class(); ?> id="<?php echo $post->post_name; ?>" itemscope itemtype="http://schema.org/NewsArticle">
            <div class="post-container">
                ...
                <div class="image-links"><i>Related Post</i><br> <a href="<?php get_permalink( get_post_parent(get_the_ID()) ); ?>"><?php if (has_post_parent(get_the_ID())) echo get_the_title( get_post_parent(get_the_ID()) ); else echo "Not attached to any posts"; ?></a></div>
            </div>
        </article>
