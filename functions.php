...
function attachment_page_image( $id ) {
    ...
    if ($fileExt == 'svg' || $fileExt == 'svgz') { // SVG Images
        ...
        return '<script defer type="module" src="https://ajax.googleapis.com/ajax/libs/model-viewer/3.3.0/model-viewer.min.js"></script><model-viewer id="Model3D" class="aligncenter" itemprop="image" style="height:350px" src="' . wp_get_attachment_url($id) . '" alt="' . wp_get_attachment_caption($id) . '" ar poster="/wp-includes/images/media/interactive.png" shadow-intensity="0" exposure="1.1" shadow-softness="0" tone-mapping="commerce" camera-controls touch-action="pan-y"></model-viewer>';
