    ...
    <form method="post" action="options.php" novalidate="novalidate">
        ...
        <table class="form-table" role="presentation">
            ...
            <tr valign="top">
                ...
                <td><input type="url" name="blank_image" id="blank_image" placeholder="<?=esc_url(home_url() . "/wp-content/themes/m20t1/assets/images/featured-blank.svg");?>" spellcheck="false" autocapitalize="none" autocorrect="off" inputmode="url" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" value="<?=esc_attr(get_option('blank_image'));?>"> <img src="<?=esc_attr(get_option('blank_image'));?>" alt="" class="form-image" loading="lazy" decoding="async"></td>
            </tr>
        </table>
