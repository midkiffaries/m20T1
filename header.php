            ...
            <div class="header-content">
                <div id="MainMenu" class="pull-menu-left menubar">
                    ...
                    <div class="header-buttons">
                        ...
                        <button class="menu-light-switch" aria-label="Light switch" id="btnLightSwitch" accesskey="d" title="Switch mode"><?=do_blocks( '<!-- wp:icon {"icon":"m20t1/moon","style":{"dimensions":{"width":"40px"}}} /-->' );?></button>
                    </div>
                </div>
            </div>
