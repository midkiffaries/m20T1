...
function attachment_page_image( $id ) {
    ...
    if ($fileExt == 'svg' || $fileExt == 'svgz') { // SVG Images
        ...
        return '<script type="module" src="https://ajax.googleapis.com/ajax/libs/model-viewer/3.3.0/model-viewer.min.js"></script><model-viewer class="aligncenter" style="height:300px" src="' . wp_get_attachment_url($id) . '" alt="' . wp_get_attachment_caption($id) . '"  ar poster="" shadow-intensity="1" camera-controls touch-action="pan-y"></model-viewer>';
