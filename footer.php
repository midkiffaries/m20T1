...
<footer class="page-footer" role="contentinfo">
    ...
    <div class="footer-notice">
        ...
        <p class="footnote">Site designed and developed by <a href="https://www.marchtwenty.com/" class="icon-bear" rel="author">Ted Balmer</a>. <?php echo wp_get_theme()->get('Name') . " - " . wp_get_theme()->get('Version'); ?></p>
    </div>
</footer>
